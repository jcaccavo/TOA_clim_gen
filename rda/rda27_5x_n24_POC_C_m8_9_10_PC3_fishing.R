...
envs <- read.csv("/srv/public/users/jcaccavo/11_CCGA_full_seq/02_NovaSeq/02_WG/24_gea/02_env_data/rda27_5x_n24_POC_C_m8_9_10_PC3_fishing.csv")
...
# ****UP TO HERE**** ####
# running in jc_screen_2

# need to compare this candidate SNP list (n = 10,684 candidates) with the LFMM list for POC-C, to whittle down to the final overlapping candidate list
# then can proceed with adptively enriched pRDA based on subset vcf using only overlapping candidates from pRDA and LFMM run on POC-C environmental data
